...
class LogEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create log_entry" do
    assert_difference('LogEntry.count') do
      post log_entries_url, params: { log_entry: { day: @log_entry.day, description: @log_entry.description, time: @log_entry.time } }
    end
  ...
  test "should update log_entry" do
    patch log_entry_url(@log_entry), params: { log_entry: { day: @log_entry.day, description: @log_entry.description, time: @log_entry.time } }
